/datum/faith/divine
	...
	desc = "The TEN, holy and eternal. The most accepted religion in Twilight Axis. The TEN became active in the lives of mortals after Psydon sent the Comet Syon to defeat the rampaging Archdevil and vanished from the world. \n \n\
