...
/obj/item/quiver/twilight_bullet/runicbag
	name = "pharetra"
	desc = "Металлический контейнер для хранения рунических пуль. Нанесенная на корпус руна привязывается к хранящимся внутри боеприпасам, и при активации возвращает уже отстреленные рунические пули в хранилище для повторного использования."
	icon_state = "runebag"
	item_state = "runebag"
	max_storage = 10
